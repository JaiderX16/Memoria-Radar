...
const MiaMobile = ({ isOpen, setIsOpen, chatState, setChatState }) => {
    ...
    return (
        <div
            className={`fixed bottom-0 left-0 right-0 z-50 flex flex-col rounded-t-[32px] shadow-2xl border-t border-gray-200/50 dark:border-white/10 overflow-hidden bg-white dark:bg-[#121214]`}
            style={{
