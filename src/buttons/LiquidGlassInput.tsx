...
export const LiquidGlassInput: React.FC<LiquidGlassInputProps> = ({
  ...
  return (
    <div className={`relative w-full h-16 rounded-full shadow-[0_20px_40px_rgba(0,0,0,0.3)] group transition-all duration-300 ${isDarkMode ? 'bg-[#1c1c1e]/40 backdrop-blur-xl border border-white/20' : 'bg-white/40 backdrop-blur-xl border border-black/10'} ${isFocused ? 'ring-2 ring-blue-500/50' : ''} ${className}`}>
